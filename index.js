...
if (pageName === "about.html") {
	document.querySelector(".about_nav").classList.add("active");
}
...
if (pageName === "Excos.html") {
	document.querySelector(".Excos").classList.add("active");
}
if (pageName === "advisers.html") {
	document.querySelector(".Advisers").classList.add("active");
}
if (pageName === "advisers.html") {
	document.querySelector(".Advisers").classList.add("active");
}
